...
class DeviceGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("goblobapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Device entity")
        ...
        .repeat(2) {
            ...
            .repeat(5) {
                ...
                .get("/goblob${new_device_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created device")
            .delete("/goblob${new_device_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
